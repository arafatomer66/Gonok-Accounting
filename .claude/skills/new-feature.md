---
description: Scaffold a new feature page for the Gonok app.
---
...
2. Which store(s) it needs (CatalogStore, TransactionStore, ExpenseStore, CrmStore, AuthStore)
...
Use existing feature components (like products, parties, or CRM) as reference for the exact patterns.
