...
@Component({
  ...
  template: `
    <div class="page-header">
      ...
      <button class="btn btn--primary" (click)="openForm()">+ New Purchase</button>
    </div>

    <gonok-transaction-list
      [transactions]="transactionStore.purchases()"
      partyLabel="Supplier"
      invoiceLabel="PO No"
    ...
    <gonok-confirm-dialog
      ...
      message="Delete this purchase transaction? Stock and balance will be reversed."
      confirmLabel="Delete"
      variant="danger"
      (confirmed)="doDelete()"
...
export class PurchaseComponent implements OnInit {
  ...
  txType = ETransactionType.PURCHASE;
